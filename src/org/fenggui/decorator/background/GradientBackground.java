 ...
 * $Id: GradientBackground.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
...
public class GradientBackground extends Background
{
  ...
  {
    b.drawBlendedFilledRect(localX, localY, width, height, lowerLeft, lowerRight, upperRight, upperLeft);
  }
  ...
  {
    GradientBackground result = new GradientBackground(this.lowerLeft, this.lowerRight, this.upperRight, this.upperLeft);
    super.copy(result);
    return result;
  }
