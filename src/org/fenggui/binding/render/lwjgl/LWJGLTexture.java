...
public class LWJGLTexture implements ITexture
{
   ...
   * @throws IOException 
   */
  public LWJGLTexture(InputOnlyStream stream) throws IOException, IXMLStreamableException
  {
    process(stream);
  }
  ...
  public void texSubImage2D(int xOffset, int yOffset, int width, int height, ByteBuffer buffer)
  {
    ...
    GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, 0, xOffset, yOffset, width, height, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE,
      buffer);
