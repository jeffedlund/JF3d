 ...
 * 
 * $Id: LWJGLOpenGL.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
...
public class LWJGLOpenGL implements IOpenGL
{
  ...
  public void setTexEnvModeDecal()
  {
    ...
    // GL11.glTexEnvf(GL11.GL_TEXTURE_ENV, GL11.GL_TEXTURE_ENV_COLOR,
  ...
  {
    // GL11.glColor4f(red * alpha, green * alpha, blue * alpha, alpha);
  ...
  {
    if (openGLThread == Thread.currentThread())
      return true;
    return false;
  }
}
