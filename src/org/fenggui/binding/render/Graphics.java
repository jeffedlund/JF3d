...
public class Graphics
{
  ...
  {
    private ArrayList<Rectangle> clips = new ArrayList<Rectangle>();
   ...
   * <p>NOTE: This should not be used as it destroyes the current clipping space.</p>
   * 
   * @param x
  ...
  public void drawScaledImage(ITexture tex, int x, int y, int width, int height)
  {
    ...
    // texture (0,0->1,1)
    Rectangle clipSpace = clipSpaces.getClipSpace();
    if (x < clipSpace.getX())
    {
