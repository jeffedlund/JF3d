 ...
 * $Id: Spacing.java 614 2009-03-28 13:13:57Z marcmenghin $
 */
 ...
 * of these methods.
 * 
 * @author Graham Briggs, last edited by $Author: marcmenghin $, $Date: 2009-03-28 14:13:57 +0100 (Sa, 28 Mär 2009) $
 * @version $Revision: 614 $
 */
@DefaultElementName("Spacing")
public class Spacing implements IXMLStreamable, Cloneable
{
  private int top;
  ...
  {
    if (value < 0)
      throw new IllegalArgumentException("spacing parameter < 0");
  }
  ...
  public Spacing clone()
  {
    ...
    catch (CloneNotSupportedException e)
    {
      ...
      Log.error("Couldn't clone Spacing", e);
      return null;
    }
  }
