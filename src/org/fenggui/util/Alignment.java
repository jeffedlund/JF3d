 ...
 * $Id: Alignment.java 613 2009-03-25 22:02:20Z marcmenghin $
 */
 ...
 * 
 * @author Graham Briggs, last edited by $Author: marcmenghin $, $Date: 2009-03-25 23:02:20 +0100 (Mi, 25 Mär 2009) $
...
public enum Alignment 
{
  ...
  MIDDLE(0.5, 0.5)
  {
    ...
    public Point alignBox(Point o, Dimension s, Dimension b)
    {
      return new Point(o.getX() + (s.getWidth() - b.getWidth()) / 2, o.getY() + (s.getHeight() - b.getHeight()) / 2);
    }
  },
  ...
  public static final StorageFormat<Alignment, String> STORAGE_FORMAT = new StorageFormat<Alignment, String>()
                                                                      {
                                                                        ...
                                                                        public String encode(Alignment obj)
                                                                        ...
                                                                        public Alignment decode(String encodedObj)
                                                                            throws EncodingException
                                                                        {
                                                                          if (encodedObj.equalsIgnoreCase("left"))
                                                                            return LEFT;
                                                                          else if (encodedObj.equalsIgnoreCase("right"))
                                                                            return RIGHT;
                                                                          else if (encodedObj
                                                                              .equalsIgnoreCase("bottom"))
                                                                            return BOTTOM;
                                                                          else if (encodedObj.equalsIgnoreCase("top"))
                                                                            return TOP;
                                                                          else if (encodedObj
                                                                              .equalsIgnoreCase("middle"))
                                                                            return MIDDLE;
                                                                          else if (encodedObj
                                                                              .equalsIgnoreCase("top left"))
                                                                            return TOP_LEFT;
                                                                          else if (encodedObj
                                                                              .equalsIgnoreCase("top right"))
                                                                            return TOP_RIGHT;
                                                                          else if (encodedObj
                                                                              .equalsIgnoreCase("bottom left"))
                                                                            return BOTTOM_LEFT;
                                                                          else
                                                                            return BOTTOM_RIGHT;
                                                                        }
