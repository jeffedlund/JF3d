 ...
 * 
 * $Id: Alphabet.java 628 2009-04-22 13:17:09Z marcmenghin $
 */
 ...
 * 
 * @author Johannes Schaback, last edited by $Author: marcmenghin $, $Date: 2009-04-22 15:17:09 +0200 (Mi, 22 Apr 2009) $
...
public class Alphabet
{
  ...
  public static final Alphabet GERMAN          = new Alphabet(new char[] { 0x00C4, 0x00D6, 0x00DC, 0x00E4, 0x00F6,
      0x00FC, 0x00DF                          });

  /* see http://www.geocities.com/click2speak/unicode/chars_fr.html */
  public static final Alphabet FRENCH          = new Alphabet(new char[] { 0x00C0, 0x00C2, 0x00C6, 0x00C8, 0x00C9,
      0x00CA, 0x00CB, 0x00CE, 0x00CF, 0x00D4, 0x0152, 0x00D9, 0x00DB, 0x00DC, 0x0178, 0x00C7, 0x00E0, 0x00E2, 0x00E6,
      0x00E8, 0x00E9, 0x00EA, 0x00EB, 0x00EE, 0x00EF, 0x00F4, 0x0153, 0x00F9, 0x00FB, 0x00FC, 0x00FF, 0x00E7 });
  
  public static final Alphabet ESTONIAN        = new Alphabet(new char[] { 0x00F6, 0x00E4, 0x00F5, 0x00FC, 0x00D6,
      0x00C4, 0x00D5, 0x00DC                  });
  
  /* see http://www.geocities.com/click2speak/unicode/chars_da.html */
  public static final Alphabet DANISH          = new Alphabet(new char[] { 0x00C6, 0x00C5, 0x00D8, 0x00E6, 0x00E5, 0x00F8});
