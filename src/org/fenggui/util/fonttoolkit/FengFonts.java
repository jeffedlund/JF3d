...
public class FengFonts extends JDialog implements ActionListener
{
  ...
  private void generateFont()
  {
    ...
    ImageFont font = FontFactory.renderStandardFont(awtFont, antialias, Alphabet.getDefaultAlphabet());
  ...
  private String getSavePath()
  {
    ...
    {
      int opt = JOptionPane.showConfirmDialog(this, "Overwrite existing file?", "FontCreator",
