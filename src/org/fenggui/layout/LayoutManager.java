 ...
 * $Id: LayoutManager.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
...
public abstract class LayoutManager implements IXMLStreamable
{
  ...
  {
    if (w.isShrinkable())
      return w.getMinSize().getHeight();
    else
      return w.getSize().getHeight();
  }

  public int getValidMinWidth(IWidget w)
  {
    if (w.isShrinkable())
      return w.getMinSize().getWidth();
    else
      return w.getSize().getWidth();
  }
