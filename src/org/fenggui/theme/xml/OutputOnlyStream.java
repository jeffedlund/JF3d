 ...
 * 
 * $Id: OutputOnlyStream.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
...
public abstract class OutputOnlyStream extends InputOutputStream
{
  ...
  public OutputOnlyStream(boolean saveDefaultValues, GlobalContextHandler contextHandler)
  {
  ...
  protected void putObject(String name, IXMLStreamable object) throws NameShadowingException
  {
   ...
   */
  @Override
  public double processAttribute(String name, double value, double defaultValue) throws IOException,
      MalformedElementException
  {
    if (dontSaveDefaultValues && value > defaultValue - DOUBLE_EQUALITY_IMPRECISION
   ...
   */
  @Override
  public String processAttribute(String name, String value, String defaultValue) throws IOException,
      MalformedElementException
  {
